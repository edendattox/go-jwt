...
import (
	...
	helper "github.com/edendattox/go-jwt/helpers"
	"github.com/edendattox/go-jwt/models"
...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		token, refresh_token, err := helper.GenerateAllTokens(*foundUser.Email, *foundUser.First_name, *foundUser.Last_name, *foundUser.User_type, *&foundUser.User_id)
